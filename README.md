...
Команда разработки:
- :white_check_mark: [Anton Pochkay (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/Pochkay)
- :white_check_mark: [Stanislav Krutskikh (в роли Python-разработчика - разработчик 2)](https://github.com/StasKrut)
...
Авторы в рамках учебного курса ЯП Python - разработчик:
- :white_check_mark: [Anton Pochkay (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/Pochkay)
- :white_check_mark: [Stanislav Krutskikh (в роли Python-разработчика - разработчик 2)](https://github.com/StasKrut)
